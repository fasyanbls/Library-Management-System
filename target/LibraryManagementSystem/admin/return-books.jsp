            ...
            <div class="search-section">
                ...
                <form action="${pageContext.request.contextPath}/admin/return-books" method="get" class="search-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bookId" name="bookId" placeholder="Enter Book ID" value="${param.bookId}">
                    </div>
                    
                    <div class="form-group">
                        <label for="memberId">Member ID</label>
                        <input type="text" class="form-control" id="memberId" name="memberId" placeholder="Enter Member ID" value="${param.memberId}">
                    </div>
