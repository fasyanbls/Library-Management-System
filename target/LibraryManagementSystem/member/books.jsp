...
<div id="borrow-modal" class="modal">
    <div class="modal-content">
        ...
        <p id="borrow-confirmation-message">Apakah Anda yakin ingin meminjam buku ini?</p>
        <p><strong>Judul:</strong> <span id="modal-book-title"></span></p>
        <p><strong>Penulis:</strong> <span id="modal-book-author"></span></p>
        <p><strong>ISBN:</strong> <span id="modal-book-isbn"></span></p>
        <p><strong>Tanggal Pengembalian:</strong> <span id="modal-due-date"></span></p>
...
<script>
    ...
    // Functions
    function openBorrowModal(bookId, bookTitle, bookAuthor, bookISBN) {
