  ...
  private void issueBook(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        if (success) {
            ...
            // PERBAIKAN 6: Gunakan redirect alih-alih forward untuk memastikan refresh data
            response.sendRedirect(request.getContextPath() + "/admin/issued-books?success=true");
